                                    <nav component="sidebar/right" class="{{{ if config.theme.openSidebars}}}open{{{ end }}} text-light bg-dark sidebar sidebar-right end-0 border-start vh-100 d-none d-lg-flex flex-column sticky-top">
                                        {{{ if config.loggedIn }}}
